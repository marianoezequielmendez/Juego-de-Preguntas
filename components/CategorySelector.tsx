      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
        {categories.map((category) => (
          <button
            ...
            className={`group relative p-6 rounded-xl bg-slate-800/50 border border-slate-700 hover:border-slate-500 transition-all duration-300 text-left overflow-hidden`}
          >
